...
export default class wj5SpellingOfSoundsPage {
  ...
  async completeTheTakenTestForSPLSNDTest(
    typeOfTest: string,
    ...
    while (await this.plainNextButtonOrEndButton.isVisible()) {
      ...
      if (typeOfTest.match(/Sample Items End Test Flow scenario/i)) {
      ...
      } else if (typeOfTest.match(/Block A End Test Scenario With All incorrect|Block B All incorrect Scenario/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        } else if (itemDetails.startsWith("Item")) {
          await incorrectlocator.click(); 
        }
      } else if (typeOfTest.match(/Block A, Block B and Block C All correct Scenario/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        } else if (itemDetails.startsWith("Item")) {
          await correctlocator.click();
      ...
      } else if (typeOfTest.match(/Block A All correct and Block B All incorrect Scenario/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
      ...
      } else if (typeOfTest.match(/Block A, Block B All correct and Block C All incorrect Scenario/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        } else if (/^Item ([1-9]|1[0-9]|2[0-3])\b/.test(itemDetails)) {
          await correctlocator.click();
        } else if (/^Item 2[4-8]\b/.test(itemDetails)) {
          await incorrectlocator.click();
        }
      } else if (typeOfTest.match(/Block B and Block C All correct Scenario|Block B All correct scenario/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        } else if (itemDetails.startsWith("Item")) {
          await correctlocator.click();
        }
      } else if (typeOfTest.match(/Block A Review Flow Logic/i)) {
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        ...
        if (itemDetails.startsWith("Sample")) {
          ...
          await correctlocator.click();
          await this.FlagIcon.click();
        } else if (/^Item (1[0-9]|2[0-2])\b/.test(itemDetails)) {
          await incorrectlocator.click();
      ...
      if (typeOfTest.match(/Block B Review Flow Logic|Block A Review Flow Logic/i)) {
        break;
      } else {
