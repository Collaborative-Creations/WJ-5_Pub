...
export default class wj5RpdpicPage {
  ...
  async completeTheTakenTestForRPDPICTest(
    typeOfTest: string
    ...
    while (await this.plainNextButtonOrEndButton.isVisible()) {
      ...
      if (
        ...
        typeOfTest.match(/Test Items 10 Incorrect scenario/i)
      ) {
        if (itemDetails.startsWith("Sample")) {
          await this.doneButton.click();
        }else if (itemDetails.startsWith("Introduction")) {
        ...
        typeOfTest.match(/Test Items When Timer Ran Out for First Item set/i)
      ) {
        if (itemDetails.startsWith("Sample")) {
          await this.doneButton.click();
        }else if (itemDetails.startsWith("Introduction")) {
        ...
        typeOfTest.match(/Test Items When Timer Ran Out for Last Item set/i)
      ) {
        if (itemDetails.startsWith("Sample")) {
          await this.doneButton.click();
