...
export default class wj5AcademicVocabularyPage {
  ...
  async completeTheTakenTestForACDVOCTest(
    typeOfTest: string,
    ...
    while (await this.plainNextButtonOrEndButton.isVisible()) {
      ...
      if (typeOfTest.match(/Basal and ceiling with 5 incorrect scenario/i)) {
        ...
        if (/^Item (1|4|3)\b/.test(itemDetails)) {
          await iDontKnow.click();
        ...
        if (itemDetails.startsWith("Sample")) {
          await correctlocator.click();
        } else if (/^Item (2|3|5|10)\b/.test(itemDetails)) {
          await iDontKnow.click();
        } else if (itemDetails === 'Item 1') {
          await iDontKnow.click();
          await this.FlagIcon.click();
      ...
      } else if (typeOfTest.match(/Review flow Scenario for SSP5/i)) {
        if (/^Item (1|2|3|10|15)\b/.test(itemDetails)) {
          await iDontKnow.click();
        } else if (itemDetails === 'Item 5') {
          await iDontKnow.click();
          await this.FlagIcon.click();
