...
export default class wj5VrbanlPage {
  ...
  async completeTheTakenTestForVRBANL(
    typeOfTest: string
    ...
    while (await this.plainNextButtonOrEndButton.isVisible()) {
      ...
      if(itemDetails.match(/Trial 1/i)){
        ...
        if (testType && itemNumber) {
          const conditions = {
            SSP2: { dontKnow: [4, 1, ...Array.from({ length: 3 }, (_, i) => (i === 2 ? 5 : 2 + i))] },
            SSP3: { dontKnow: [9, 4, 1, ...Array.from({ length: 3 }, (_, i) => (i === 2 ? 5 : 2 + i))] },
            SSP4: { dontKnow: [12, 7, 2, 1, ...Array.from({ length: 3 }, (_, i) => 3 + i)] },
            SSP5: { dontKnow: [16, 11, 6, 1, ...Array.from({ length: 4 }, (_, i) => 2 + i)] },
          };
        ...
        if (testType && itemNumber) {
            const ranges = {
              ...
              SSP2: { correctRange: [4, 5, 6, 7, 8], dontKnowRange: [9, 10, 11, 12, 13] },
              SSP3: { correctRange: [9, 10, 11, 12, 13], dontKnowRange: [14, 15, 16, 17, 18] },
              SSP4: { correctRange: [12, 13, 14, 15, 16], dontKnowRange: [17, 18, 19, 20, 21] },
              SSP5: { correctRange: [16, 17, 18, 19, 20], dontKnowRange: [21, 22, 23, 24, 25] },
            };
