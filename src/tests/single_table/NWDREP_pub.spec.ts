...
import { testData } from "../../scenarios/single_table/NWDREP_pub.scenarios";
...
test.describe("NWDREP.W5PA single table lookUp Scoring Export Automation", () => {
