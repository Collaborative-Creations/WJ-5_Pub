...
import { testData } from "../../scenarios/single_table/VRBANL_Pub.scenarios";
...
test.describe("VRBANL.W5PA single table lookUp Scoring Export Automation", () => {
