...
import { testData } from "../../scenarios/single_table/PHNRET_Pub.scenarios";
...
test.describe(" PHNRET.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTestPage.completeTheTakenTestForWlookUpScoresForPHNRETTest(
            data.typeOfTest,
          );
