...
import { testData } from "../../scenarios/single_table/OVSYN_Pub.scenarios";
...
test.describe("OVSYN.W5PA single table lookUp Scoring Export Automation", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@OVSYN", "@SingleTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
