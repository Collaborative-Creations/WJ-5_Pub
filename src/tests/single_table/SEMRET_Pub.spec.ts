...
import { testData } from "../../scenarios/single_table/SEMRET_Pub.scenarios";
...
test.describe(" SEMRET.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTestPage.completeTheTakenTestForWlookUpScoresForSEMRETTest(
            data.typeOfTest,
          );
