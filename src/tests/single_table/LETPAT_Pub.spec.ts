...
import { testData } from "../../scenarios/single_table/LETPAT_Pub.scenarios";
...
test.describe(" LETPAT.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@LETPAT", "@SingleTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTestPage.completeTheTakenTestForWlookUpScoresForLETPATTest(
            data.typeOfTest,
          );
        if (
