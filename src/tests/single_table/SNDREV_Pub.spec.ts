...
import { testData } from "../../scenarios/single_table/SNDREV_Pub.scenarios";
...
test.describe("SNDREV.W5PA single table lookUp Scoring Export Automation", () => {
