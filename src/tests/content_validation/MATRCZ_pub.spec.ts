...
import { testData } from "../../scenarios/content_validation/MATRCZ_pub.scenarios";
    ...
    test(
      ...
      async ({
        ...
        for (let i = 0; i < data.testName.length; i++) {
          ...
          score =
            await wj5examinerTest_contentPage.completeTheContentValidationForMATRCZTest(
              data.typeOfTest,
              data.testStemForm[i],
              data.BbyC![i],
              data.scoreFlag,
