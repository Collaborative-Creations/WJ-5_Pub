...
import { testData } from "../../scenarios/content_validation/SWRTAC_pub.scenarios";
    ...
    test(
      ...
      async ({
        ...
        for (let i = 0; i < data.testName.length; i++) {
          ...
          score =
            await wj5examinerTest_contentPage.completeTheContentValidationForSWRTACTest(
              data.typeOfTest,
              data.testStemForm[i],
              data.BbyC![i],
              data.scoreFlag,
