...
import { testData } from "../../scenarios/content_validation/RPDPIC_pub.scenarios";
    ...
    test(
      ...
      async ({
        ...
        for (let i = 0; i < data.testName.length; i++) {
          ...
          score =
            await wj5examinerTest_contentPage.completeTheContentValidationForRPDPICTest(
              data.typeOfTest,
              data.testStemForm[i],
              data.BbyC![i],
              data.scoreFlag,
