...
import { testData } from "../../scenarios/decile_table/RPDPHO_pub.scenarios";
...
test.describe(" RPDPHO.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@RPDPHO", "@decileTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTest_decileTablePage.completeTheTakenTestForWlookUpScoresForRPDPHOTest(
            data.typeOfTest,
            data.BbyC,
          );
