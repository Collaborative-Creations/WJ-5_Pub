...
import { testData } from "../../scenarios/test_dataExport/MATRCZ_Pub.scenarios";
...
test.describe("MATRCZ.W5PA Test Data Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_dataExportPage.completeTheTakenTestForTestDataExportForMATRCZTest(
            data.typeOfTest,
          );
        if (
