...
import { testData } from "../../scenarios/Left_Nav/MEMWRD_pub.scenarios";
  ...
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
        await wj5examinerTest_leftnavPage.completeTheLeftNavValidationForMEMWRDTest(
            data.typeOfTest,
          );
          if (
