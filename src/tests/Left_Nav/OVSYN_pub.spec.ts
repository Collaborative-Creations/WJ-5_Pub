...
import { testData } from "../../scenarios/Left_Nav/OVSYN_pub.scenarios";
  ...
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_leftnavPage.completeTheLeftNavValidationForTakenTests(
            data.typeOfTest,
          );
        if (data.typeOfTest.match(/left Nav For SSP2|left Nav For SSP3/i)) {
