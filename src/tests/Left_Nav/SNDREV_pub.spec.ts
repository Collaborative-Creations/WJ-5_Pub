...
import { testData } from "../../scenarios/Left_Nav/SNDREV_pub.scenarios";
  ...
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_leftnavPage.completeTheLeftNavValidationForSNDREVTest(
            data.typeOfTest,
          );
        if (
