...
import { testData } from "../../scenarios/Left_Nav/MTHFLU_pub.scenarios";
...
test.describe(" LeftNav Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@Regression", "@MTHFLULN", "@leftnav"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
        await wj5examinerTest_leftnavPage.completeTheLeftNavValidationForMTHFLUTest(
            data.typeOfTest,
          );
          if (
