...
import { testData } from "../../scenarios/Left_Nav/RPDPHO_pub.scenarios";
  ...
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
        await wj5examinerTest_leftnavPage.completeTheLeftNavValidationForRPDPHOTest(
            data.typeOfTest,
          );
          if (
