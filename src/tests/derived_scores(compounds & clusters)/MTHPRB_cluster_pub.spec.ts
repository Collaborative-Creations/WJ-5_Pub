...
import { testData } from "../../scenarios/derived_scores(compounds & clusters)/MTHPRB_Pub_cluster.scenarios";
...
test.describe(" MTHPRB cluster Derived Export Automation ", () => {
  testData.forEach((data) => {
    test(
      `For ${data.typeOfTest} Complete The MTHPRB cluster & generate report`,
      { tag: ["@MTHPRB", "@Regression", "@DerivedScores"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
