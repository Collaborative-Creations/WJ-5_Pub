...
import { testData } from "../../scenarios/derived_scores(compounds & clusters)/COGEFF_Pub_cluster.scenarios";
import { getExamineeURL, getSiteUrl } from "../../utils/testData";
import { setFilePathes } from "../../utils/global";
import { ScoreObject, ExamineeData } from "../../utils/types"; // Updated import to include ExamineeData
...
test.describe(" COGEFF cluster Derived Export Automation ", () => {
