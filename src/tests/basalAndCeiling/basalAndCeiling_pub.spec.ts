...
} from "../../scenarios/basalAndCeiling/basalAndCeiling_pub.scenarios";
...
test.describe(" Automating the basal and ceiling tests", () => {
    ...
    test(
      ...
      async (
        ...
        for (let i = 0; i < data.testName.length; i++) {
          ...
          score =
            await wj5examinerTest_basalAndCeilingPage.completeTheBaselAndCeilingTestingForTheTakenTests(
              data.typeOfTest,
              data.testStemForm[i],
              data.BbyC![i],
              data.scoreFlag,
