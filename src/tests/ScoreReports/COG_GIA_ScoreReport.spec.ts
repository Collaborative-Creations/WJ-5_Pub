...
import { testData } from "../../scenarios/ScoreReports/COG_GIA.scenarios";
...
test.describe("General Intellectual Ability cluster Score Report", () => {
    testData.forEach((data) => {
        test(`Generate a Score Report for ${data.examineeName}`,
            { tag: ["@GIA", "@regression", "@ScoreReport"] },
