...
import { testData } from "../../scenarios/ScoreReports/ACH_VOCAB.scenarios";
...
test.describe("VOCAB cluster Score Report", () => {
    testData.forEach((data) => {
        test(`Generate a Score Report for ${data.examineeName}`,
            { tag: ["@VOCAB", "@regression", "@ScoreReport"] },
            async ({wj5ah,context,wj5Test_ScoreReportsPage},
                ...
                if(data.reportType.match("Word Score Report")){
