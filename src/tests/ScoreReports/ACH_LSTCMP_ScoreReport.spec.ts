...
import { testData } from "../../scenarios/ScoreReports/ACH_LSTCMP.scenarios";
...
test.describe("Listening Comprehension cluster Score Report", () => {
    testData.forEach((data) => {
        test(`Generate a Score Report for ${data.examineeName}`,
            { tag: ["@LSTCMP", "@regression", "@ScoreReport"] },
