...
import { testData } from "../../scenarios/WJV_UI_Regression/GIWHAT_Pub.scenarios";
...
test.describe(" GIWHAT UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_GIWHATPage.completeTheTakenTestForGIWHATTest(
            data.typeOfTest,
          );
