...
import { testData } from "../../scenarios/WJV_UI_Regression/LETPAT_Pub.scenarios";
...
test.describe(" LETPAT UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_LETPATPage.completeTheTakenTestForLETPATTest(
            data.typeOfTest,
          );
        if (
