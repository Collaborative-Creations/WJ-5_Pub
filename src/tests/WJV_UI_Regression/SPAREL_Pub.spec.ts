...
import { testData } from "../../scenarios/WJV_UI_Regression/SPAREL_Pub.scenarios";
...
test.describe(" SPAREL UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_sparelPage.completeTheTakenTestForSPAREL(
          data.typeOfTest
        );
