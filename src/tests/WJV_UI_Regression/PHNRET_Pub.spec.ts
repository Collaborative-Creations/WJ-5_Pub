...
import { testData } from "../../scenarios/WJV_UI_Regression/PHNRET_Pub.scenarios";
...
test.describe(" PHNRET UI Regression ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_phnretPage.completeTheTakenTestForPHNRET(
          data.typeOfTest,
        );
        if (
