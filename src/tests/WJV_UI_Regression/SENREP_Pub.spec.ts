...
import { testData } from "../../scenarios/WJV_UI_Regression/SENREP_Pub.scenarios";
...
test.describe(" SENREP UI Regression ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_senrepPage.completeTheTakenTestForSENREP(
          data.typeOfTest
        );
