...
import { testData } from "../../scenarios/WJV_UI_Regression/SNDBLN_pub.scenarios";
...
test.describe(" SNDBLN UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_SNDBLNPage.completeTheTakenTestForSNDBLNTest(
            data.typeOfTest,
          );
