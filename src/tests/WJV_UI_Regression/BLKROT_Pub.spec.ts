...
import { testData } from "../../scenarios/WJV_UI_Regression/BLKROT_Pub.scenarios";
...
test.describe(" BLKROT UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_BLKROTPage.completeTheTakenTestForBLKROTTest(
            data.typeOfTest,
          );
