...
import { testData } from "../../scenarios/WJV_UI_Regression/OVANT_Pub.scenarios";
...
test.describe(" OVANT UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_OVANTPage.completeTheTakenTestForOVANTTest(
            data.typeOfTest,
          );
