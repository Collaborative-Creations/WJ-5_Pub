...
import { testData } from "../../scenarios/WJV_UI_Regression/VRBATN_Pub.scenarios";
...
test.describe(" VRBATN UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_vrbatnPage.completeTheTakenTestForVRBATN(
          data.typeOfTest
        );
