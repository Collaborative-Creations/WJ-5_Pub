...
import { testData } from "../../scenarios/WJV_UI_Regression/ACDVOC_Pub.scenarios";
...
test.describe(" ACDVOC UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_ACDVOCPage.completeTheTakenTestForACDVOCTest(
            data.typeOfTest,
          );
