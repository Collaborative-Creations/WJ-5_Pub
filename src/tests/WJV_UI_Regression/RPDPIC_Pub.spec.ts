...
import { testData } from "../../scenarios/WJV_UI_Regression/RPDPIC_Pub.scenarios";
...
test.describe(" RPDPIC UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_rpdpicPage.completeTheTakenTestForRPDPICTest(
            data.typeOfTest
          );
