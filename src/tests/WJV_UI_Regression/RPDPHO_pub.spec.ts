...
import { testData } from "../../scenarios/WJV_UI_Regression/RPDPHO_Pub.scenarios";
...
test.describe(" RPDPHO UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_RPDPHOPage.completeTheTakenTestForRPDPHOTest(
            data.typeOfTest,
          );
