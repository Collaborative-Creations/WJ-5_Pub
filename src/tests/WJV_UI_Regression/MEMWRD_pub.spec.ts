...
import { testData } from "../../scenarios/WJV_UI_Regression/MEMWRD_Pub.scenarios";
...
test.describe(" MEMWRD UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_MEMWRDPage.completeTheTakenTestForMEMWRDTest(
            data.typeOfTest,
          );
