...
import { testData } from "../../scenarios/WJV_UI_Regression/OVSYN_Pub.scenarios";
...
test.describe(" OVSYN UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_OVSYNPage.completeTheTakenTestForOVSYNTest(
            data.typeOfTest,
          );
