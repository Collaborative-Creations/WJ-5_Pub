...
import { testData } from "../../scenarios/WJV_UI_Regression/SWRTAC_Pub.scenarios";
...
test.describe(" SWRTAC UI Regression ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_swrtacPage.completeTheTakenTestForSWRTAC(
          data.typeOfTest,
        );
        if (
