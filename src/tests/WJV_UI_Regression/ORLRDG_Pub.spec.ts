...
import { testData } from "../../scenarios/WJV_UI_Regression/ORLRDG_Pub.scenarios";
...
test.describe(" ORLRDG UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_orlrdgPage.completeTheTakenTestForORLRDG(
          data.typeOfTest,
        );
