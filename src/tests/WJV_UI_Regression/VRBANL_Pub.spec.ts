...
import { testData } from "../../scenarios/WJV_UI_Regression/VRBANL_Pub.scenarios";
...
test.describe(" VRBANL UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_vrbanlPage.completeTheTakenTestForVRBANL(
          data.typeOfTest
        );
