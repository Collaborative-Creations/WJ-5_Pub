...
import { testData } from "../../scenarios/WJV_UI_Regression/STYREC_Pub.scenarios";
...
test.describe(" STYREC UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_styrecPage.completeTheTakenTestForSTYREC(
          data.typeOfTest
        );
        if (data.typeOfTest.match(/Story 1&2 forward Flow to Story 3 when RS is 10|Story 1 to 4 forward Flow to Story 5 when RS is 24/i)) {
