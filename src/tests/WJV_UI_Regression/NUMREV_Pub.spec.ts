...
import { testData } from "../../scenarios/WJV_UI_Regression/NUMREV_Pub.scenarios";
...
test.describe(" NUMREV UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_numrevPage.completeTheTakenTestForNUMREV(
          data.typeOfTest,
        );
