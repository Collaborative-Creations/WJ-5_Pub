...
import { testData } from "../../scenarios/WJV_UI_Regression/SEMRET_Pub.scenarios";
...
test.describe(" SEMRET UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_semretPage.completeTheTakenTestForSEMRET(
          data.typeOfTest
        );
