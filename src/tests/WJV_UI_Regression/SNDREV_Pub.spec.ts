...
import { testData } from "../../scenarios/WJV_UI_Regression/SNDREV_Pub.scenarios";
...
test.describe(" SNDREV UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_SNDREVPage.completeTheTakenTestForSNDREVTest(
            data.typeOfTest,
          );
