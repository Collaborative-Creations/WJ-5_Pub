...
import { testData } from "../../scenarios/WJV_UI_Regression/NUMSER_Pub.scenarios";
...
test.describe(" NUMSER UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_numserPage.completeTheTakenTestForNUMSER(
          data.typeOfTest
        );
