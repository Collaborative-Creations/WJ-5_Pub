...
import { testData } from "../../scenarios/WJV_UI_Regression/SPELL_Pub.scenarios";
...
test.describe(" SPELL UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_spellPage.completeTheTakenTestForSPELL(
          data.typeOfTest
        );
