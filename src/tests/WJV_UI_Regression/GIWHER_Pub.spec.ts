...
import { testData } from "../../scenarios/WJV_UI_Regression/GIWHER_Pub.scenarios";
...
test.describe(" GIWHER UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_GIWHERPage.completeTheTakenTestForGIWHERTest(
            data.typeOfTest,
          );
