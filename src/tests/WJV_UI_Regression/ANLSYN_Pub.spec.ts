...
import { testData } from "../../scenarios/WJV_UI_Regression/ANLSYN_Pub.scenarios";
...
test.describe(" ANLSYN UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_ANLSYNPage.completeTheTakenTestForANLSYNTest(
            data.typeOfTest,
          );
          if (data.typeOfTest.match(/Review flow Scenario/i,)) {
