...
import { testData } from "../../scenarios/WJV_UI_Regression/CALC_Pub.scenarios";
...
test.describe(" CALC UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_CALCPage.completeTheTakenTestForCALCTest(
            data.typeOfTest,
          );
