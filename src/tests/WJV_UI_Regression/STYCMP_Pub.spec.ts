...
import { testData } from "../../scenarios/WJV_UI_Regression/STYCMP_Pub.scenarios";
...
test.describe(" STYCMP UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_stycmpPage.completeTheTakenTestForSTYCMP(
          data.typeOfTest
        );
        if (data.typeOfTest.match(/Sample Item Forward Flow when RS is 2/i)) {
