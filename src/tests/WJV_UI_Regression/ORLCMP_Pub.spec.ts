...
import { testData } from "../../scenarios/WJV_UI_Regression/ORLCMP_Pub.scenarios";
...
test.describe(" ORLCMP UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_orlcmpPage.completeTheTakenTestForORLCMP(
          data.typeOfTest
        );
