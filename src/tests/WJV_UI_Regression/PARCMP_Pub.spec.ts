...
import { testData } from "../../scenarios/WJV_UI_Regression/PARCMP_Pub.scenarios";
...
test.describe(" PARCMP UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_parcmpPage.completeTheTakenTestForPARCMP(
          data.typeOfTest
        );
