...
import { testData } from "../../scenarios/WJV_UI_Regression/RPDLET_Pub.scenarios";
...
test.describe(" RPDLET UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_rpdletPage.completeTheTakenTestForRPDLETTest(
            data.typeOfTest
          );
