...
import { testData } from "../../scenarios/WJV_UI_Regression/MATRCZ_Pub.scenarios";
...
test.describe(" MATRCZ UI Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score = await wj5examinerTest_matrczPage.completeTheTakenTestForMATRCZ(
          data.typeOfTest
        );
