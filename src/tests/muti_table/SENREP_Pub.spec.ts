...
import { testData } from "../../scenarios/multi_table/SENREP_Pub.scenarios";
...
test.describe(" SENREP.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@SENREP", "@MultiTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForSENREPTest(
            data.typeOfTest,
            data.BbyC,
          );
        if (
