...
import { testData } from "../../scenarios/multi_table/SNDDEL_Pub.scenarios";
...
test.describe(" SNDDEL.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@SNDDEL", "@MultiTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForSNDDELTest(
            data.typeOfTest,
          );
        if (
