...
import { testData } from "../../scenarios/multi_table/WRDATK_Pub.scenarios";
...
test.describe(" WRDATK.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@WRDATK", "@MultiTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForWRDATKTest(
            data.typeOfTest,
            data.BbyC,
          );
        if (
