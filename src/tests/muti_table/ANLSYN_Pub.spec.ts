...
import { testData } from "../../scenarios/multi_table/ANLSYN_Pub.scenarios";
  ...
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForAnalysisSynthesisTest(
            data.typeOfTest,
            data.BbyC,
          );
        if (
