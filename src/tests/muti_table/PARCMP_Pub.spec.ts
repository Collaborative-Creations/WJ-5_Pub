...
import { testData } from "../../scenarios/multi_table/PARCMP_Pub.scenarios";
...
test.describe(" PARCMP.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForPARCMPTest(
            data.typeOfTest,
            data.BbyC,
          );
        if (
