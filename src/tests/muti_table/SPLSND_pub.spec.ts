...
import { testData } from "../../scenarios/multi_table/SPLSND_pub.scenarios";
...
test.describe(" SPLSND.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      { tag: ["@SPLSND", "@MultiTable", "@Regression"] },
      async (
        {
          wj5ah,
          wj5AhDashPage,
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForSPLSNDTest(
            data.typeOfTest,
            data.BbyC,
          );
          if (
