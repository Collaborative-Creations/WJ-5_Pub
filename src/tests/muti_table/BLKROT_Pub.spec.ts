...
import { testData } from "../../scenarios/multi_table/BLKROT_Pub.scenarios";
...
test.describe(" BLKROT.W5PA WlookUp Scoring Export Automation ", () => {
  testData.forEach((data) => {
    ...
    test(
      ...
      async (
        ...
        score =
          await wj5examinerTest_multiTablePage.completeTheTakenTestForWlookUpScoresForBLKROTTest(
            data.typeOfTest,
            data.BbyC,
          );
