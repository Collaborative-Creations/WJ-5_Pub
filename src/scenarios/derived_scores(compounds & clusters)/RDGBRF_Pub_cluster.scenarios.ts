...
export const testData: TestData[] = [
...

  {
    ...
    testNumber: [1, 2],
    testName: ["Letter-Word Identification", "Passage Comprehension"],
    testStemForm: ["LWIDNT.W5PA", "PSGCMP.W5PA"],
    taskStem: ["LWIDNT", "PSGCMP"],
    blockName: "Form A",
    examineeAge: 5,
    examineeGrade: "1.9",
    normBasis: "Age",
    SSP: ["Ages 4 to 5", "Ages 4 to 6"],
    totalItems: 5,
    scoreFlag: "",
    BbyC: [5, 5],
    compositesOrClustersTaskStemForm: ["RDGBRF"],
